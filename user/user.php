...
<body>
    <div class="login_container">
        <header>
            <h1 style="background-color:rgba(163, 204, 51, 0.731);">User Login</h1>
        </header>
        <div class="login_form">
            <form action="" method="POST">
                ...
                <input id="loginbtn" type="submit" name="userLogin" style="background-color:crimson;" value="Login">
