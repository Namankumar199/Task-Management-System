...
<div class="container" style="background-color:#fff;">
            ...
            <div class="menus">
                <ul class="menus-list">
                    ...
                    <li><a style="background-color: rgb(51, 122, 183); color: #fff !important;border-top-right-radius: 20px;
                                    border-bottom-right-radius: 20px;" href="index.php" id="admins" >Admin</a></li>
           ...
           <table>
            ...
            <tbody>
              ...
              <tr class="status">
                    ...
                    <td hidden>
                        <a class="aDel" href="deleteAdmin.php?id=<?php echo $row['id']?>">Del</a>
                        <a class="aEdit" href="editAdmin.php?id=<?php echo $row['id']?>">Edit</a>
                     </td>
                </tr>
            <?php
             $sno++;    
 ...
 <div class="popUp">
    ...
    <form action="insertAdmin.php" method="POST">
        ...
        <input type="submit" name="createAdmin" id="createAdmin" value="Create Admin">
        </form>
    </div>
